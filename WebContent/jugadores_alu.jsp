									...
									<tbody>
										...
										for (int i = 0; i < jugadores.size(); i++) {
											...
											<td width='325' colspan="3" style="padding-left: 15px;"><% out.print(jugadores.get(i).getNombre()); %></td>
												...
												<td rowspan="2" width='60' style="text-align: center;"><p style="padding: 1rem;text-align: center; <% out.print(carta.colorPac()); %>"><% out.print(carta.getPac()); %></p></td>	
												<td rowspan="2" width='60' style="text-align: center;"><p style="padding: 1rem;text-align: center; <% out.print(carta.colorSho()); %>"><% out.print(carta.getSho()); %></p></td>
												<td rowspan="2" width='60' style="text-align: center;"><p style="padding: 1rem;text-align: center; <% out.print(carta.colorPas()); %>"><% out.print(carta.getPas()); %></p></td>
												<td rowspan="2" width='60' style="text-align: center;"><p style="padding: 1rem;text-align: center; <% out.print(carta.colorDri()); %>"><% out.print(carta.getDri()); %></p></td>
												<td rowspan="2" width='60' style="text-align: center;"><p style="padding: 1rem;text-align: center; <% out.print(carta.colorDef()); %>"><% out.print(carta.getDef()); %></p></td>
												<td rowspan="2" width='60' style="text-align: center;"><p style="padding: 1rem;text-align: center; <% out.print(carta.colorPhy()); %>"><% out.print(carta.getPhy()); %></p></td>
										...
										<tr>
										  ...
										  <td width='230'><img src="images/ligas/<% out.print(controlador.dameCodLiga(jugadores.get(i).getCod_equipo()));%>.png" style="width: 50px; height: auto;"/></td>
										</tr>
										<% 
										}																		
										%>
